...
exports.run = (client, message, params, command_success, command_fail) => {
    if(!message.member.permissions.has("MANAGE_NICKNAMES", true)) { message.react(command_fail); return message.channel.send('You do not have the required permissions to do this.'); }
